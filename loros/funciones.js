        ...
        switch (t) {
            case 1: //
                $(".mensaje-alerta").append(
                    "<div class='alert alert-success' role='alert'>Se a agregado un loro</div>"
                );
                break;
            case 2: //
                $(".mensaje-alerta").append(
                    "<div class='alert alert-danger' role='alert'>Se elimino el loro</div>"
                );
                break;
            default:
...
if (dbVacas.length !== 0) {
    ...
    $("#dbVacas-list").append("<h2> No ningun loro </h2>");
}
...
$(".btnEliminar").bind("click", function(){
    alert("¿Quieres borrar el registro?");
...
$(".btnEditar").bind("click", function() {
    alert("¿Desea editar el registro de su loro?");
    // Cambiamos el modo
